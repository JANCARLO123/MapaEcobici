...
namespace Blend.SampleData.MapSampleDataSource
{
	using System; 
...
// the DISABLE_SAMPLE_DATA conditional compilation constant and disable sample data at runtime.
	...
	internal class MapSampleDataSource { }
#else

	public class MapSampleDataSource : INotifyPropertyChanged
	{
		...
		public MapSampleDataSource()
		{
			try
			{
				Uri resourceUri = new Uri("ms-appx:/SampleData/MapSampleDataSource/MapSampleDataSource.xaml", UriKind.RelativeOrAbsolute);
